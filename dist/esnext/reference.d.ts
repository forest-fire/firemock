...
export default class Reference<T = any> extends Query<T> implements IReference {
    ...
    transaction(transactionUpdate: (a: Partial<T>) => Partial<T>, onComplete?: (a: Error | null, b: boolean, c: DataSnapshot | null) => any, applyLocally?: boolean): Promise<rtdb.ITransactionResult>;
    onDisconnect(): any;
    toString(): string;
}
