...
import { SchemaHelper } from "../mocking/index/schema-helper";
...
export declare type EventHandler =
  ...
  | HandleNewEvent
  | HandleRemoveEvent;
export declare type GenericEventHandler = (
  snap: RtdbDataSnapshot,
  key?: string
) => void;
export declare type HandleValueEvent = (dataSnapShot: RtdbDataSnapshot) => void;
export declare type HandleNewEvent = (
  childSnapshot: RtdbDataSnapshot,
  prevChildKey: string
) => void;
export declare type HandleRemoveEvent = (
  oldChildSnapshot: RtdbDataSnapshot
) => void;
export declare type HandleMoveEvent = (
  childSnapshot: RtdbDataSnapshot,
  prevChildKey: string
) => void;
export declare type HandleChangeEvent = (
  childSnapshot: RtdbDataSnapshot,
  prevChildKey: string
) => void;
